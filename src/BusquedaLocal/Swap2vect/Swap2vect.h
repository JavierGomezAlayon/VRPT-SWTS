...
// Fecha: 04/14/25
// Archivo Swap2vect.h : Declaración de la clase Swap2vect
//        En este fichero se declara la clase Swap2vect
//
// Historial de revisiones
//        04/14/25 - Creación (primera versión) del código
#ifndef C_Swap2vect_H
#define C_Swap2vect_H
#include"../BusquedaLocal.h"


class Swap2vect : public BusquedaLocal {
 public:
  Swap2vect();
